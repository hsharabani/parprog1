...
class BlurSuite extends FunSuite {
  ...
  test("HorizontalBoxBlur.parBlur 1 task with radius 1 should correctly blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("HorizontalBoxBlur.parBlur 40 tasks with radius 1 should correctly blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
    ...
    HorizontalBoxBlur.parBlur(src, dst, 40, 1)
  ...
  test("HorizontalBoxBlur.parBlur 2 tasks with radius 1 should correctly blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur 1 task with radius 2 should correctly blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur 2 tasks with radius 2 should correctly blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur 40 tasks with radius 2 should correctly blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
    ...
    VerticalBoxBlur.parBlur(src, dst, 40, 2)
